...
#ifndef PC_LIBPC_SRC_PC_UTILS_NET_UTIL_H_
#define PC_LIBPC_SRC_PC_UTILS_NET_UTIL_H_
...
namespace pc
{
    namespace utils
    {
        ...
        inline uint64_t S64(const char *s)
        {
            int64_t i;
            char c;
        ...
        /// Fill in Ethernet header \p eth_header using the source and destination MAC
...
#endif // PC_LIBPC_SRC_PC_UTILS_NET_UTIL_H_
