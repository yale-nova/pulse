...
#include "../../benchmark/src/benchmark_utils.h"
...
DEFINE_uint64(agg_query, 0, "Aggregation query");
...
class BTrDBClientContext : public ClientContext
{
public:
