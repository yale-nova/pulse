...
int main(int argc, char **argv)
{
  ...
  int ret;
  WT_CONNECTION *conn;
  ret = wiredtiger_open("/home/yupeng/db", NULL, "create", &conn);

  // TODO ignore background threads for now
  ...
  //  auto req_handler_type = FLAGS_num_server_bg_threads > 0
  //                              ? erpc::ReqFuncType::kBackground
  //                              : erpc::ReqFuncType::kForeground;
  //  nexus.register_req_func(kAppReqType, req_handler, req_handler_type);
