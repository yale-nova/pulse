...
class LatencyClientContext : public BasicAppContext
{
...
public:
  ...
  ~LatencyClientContext() { hdr_close(latency_hist_); }
};
...
void connect_sessions(LatencyClientContext &c)
{
...
inline void send_req(LatencyClientContext &c)
{
...
{
  auto *c = static_cast<LatencyClientContext *>(_context);
