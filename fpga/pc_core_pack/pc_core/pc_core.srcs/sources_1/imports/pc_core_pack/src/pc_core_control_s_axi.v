...
//        others - reserved
// 0x10 : Data signal of coreconfig
//        bit 31~0 - coreconfig[31:0] (Read/Write)
// 0x14 : reserved
...
localparam
    ...
    ADDR_IER               = 6'h08,
    ADDR_ISR               = 6'h0c,
    ADDR_CORECONFIG_DATA_0 = 6'h10,
    ADDR_CORECONFIG_CTRL   = 6'h14,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_CORECONFIG_DATA_0: begin
                    rdata <= int_coreconfig[31:0];
                end
...
assign coreconfig        = int_coreconfig;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_coreconfig[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_CORECONFIG_DATA_0)
            int_coreconfig[31:0] <= (WDATA[31:0] & wmask) | (int_coreconfig[31:0] & ~wmask);
    end
end
